...
The collection page has a vertical category menu: All posts, Technology, Travel, General, and Anime. Choose a category in the composer's Post details before applying or submitting changes. Editors' category changes need creator approval; existing uncategorized posts appear under General. The menu and editor labels support English and Spanish.
